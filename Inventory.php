...
if(isset($_POST['submit'])){
    ...
    $sql ="INSERT INTO `inventory`(`Product_Name`, `Product_Description`, `Quantity_order`, `MFG_Date`, `EXP_Date`, `Supplier`) VALUES ('$product','$description','$order','$mfg','$exp','$supplier')";
        ...
        <div class="row">
            <div class="col-8">
                ...
                <form action="" method="post">
                    ...
                    <input type="text" name="description" id="descripation" class="form-control">
                    ...
                    <div class="row">
                        ...
                        <input type="date" name="mfg" id="mfg" class="form-control">
                        </div>
                        <div class="col-6">
                    ...
                    <input type="submit" class="btn btn-primary" name="submit" value="Add" style="width: 20%;">
