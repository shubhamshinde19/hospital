                  ...
                  <div class="container">
                        ...
                        <tr>
                          ...
                          <div class="dropdown-content">
                            <a href="ipdedit.php?id=<?php echo $row['id'];?>"class="fa fa-pencil" style="font-size:30px;color:black;"></a>
                            <a href="ipddelete.php?id=<?php echo $row['id'];?>"class="fa fa-trash " style="font-size:30px;color:red;"></a>
