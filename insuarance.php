        ...
        <div class="row">
            ...
            <center><img width="100" align="center" src="images/1600w-hbl5vlZh180.webp"><br>
                ...
                <div class="dropdown" style="width:100%;margin-left:7px">
                   ...
                   <ul class="dropdown-menu">
                     <li><a class="dropdown-item" href="insuarance.php">Insurance Claim Processing</a></li>
            ...
            <div class="col-sm-10">
                <nav class="navbar navbar-expand-lg bg-body-tertiary" >
                  ...
                  <div class="fluid-container p-5" style="background-color: #b3d9ff; line-height: 2; ">
                        <h2 class="text-primary"><i class="fa-solid fa-hand-holding-droplet"></i> &nbsp;&nbsp; Insuarance Claim Form</h2> <hr>
                        <form action="" method="post">

                            <label for="insuarance">Insuarance Plan Name :</label>
                            <input type="text" name="insuarnce" class="form-control">
                            ...
                            <input type="submit" name="submit" value="Submit" class="form-control bg bg-primary">
