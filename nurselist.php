                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><a href="editnurse.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil" style="font-size:20px; color:black;"></i></a>
                                    <a href="deletenurse.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" style="font-size:20px; color:red;"></i></a></td>
                                </tr>
                            </tbody>
                            <?php } ?>
                        </table>
